...
[`std::concat!`][std::concat!] with support for `const` variables and expressions.
...
[`concat!`][concat] works exactly like [`std::concat!`][std::concat!], concatenating [`&str`][str]
...
[`concat_bytes!`][concat_bytes] works similarly to [`concat!`][concat], concatenating `const`
[`&[u8]`][u8] expressions and literals into a static byte slice.
...
[`concat_slices!`][concat_slices] is the underlying macro used for both of the above, this
can be used to concatenate `const` [`&[T]`][T] expressions into a static
slice.
...
[concat]: https://docs.rs/constcat/latest/constcat/macro.concat.html
[concat_bytes]: https://docs.rs/constcat/latest/constcat/macro.concat_bytes.html
[concat_slices]: https://docs.rs/constcat/latest/constcat/macro.concat_slices.html
